export default {
    ...
    productOrdersRadialBar: {
        analyticsData: [
            { 'orderType': 'Leads', 'counts': 23043, color: 'success' },
            { 'orderType': 'Clicks', 'counts': 14658, color: 'warning' },
            { 'orderType': 'Opens ', 'counts': 4758, color: 'danger' },
        ],
        series: [70, 52, 26],
        chartOptions: {
